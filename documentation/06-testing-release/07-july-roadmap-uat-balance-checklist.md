---
Title: "First Pig Kin Demo UAT Balance Checklist"
Status: Canonical
Last Updated: 2026-08-01
Owner: Product + QA + Engineering
Depends On:
  - documentation/06-testing-release/02-critical-path-playtest-script.md
  - documentation/06-testing-release/04-player-friction-severity-rubric.md
  - agent/ISSUES.md
...
- Pair shrine-feel notes with `documentation/06-testing-release/evidence/03-shrine-tuning-sample-evidence.md` and `npm.cmd run sim:shrines:docker` when the issue is about shrine quality, effect mix, costs, or perceived reward value.

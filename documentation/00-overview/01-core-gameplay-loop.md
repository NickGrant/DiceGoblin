...
2. Select a saved warband (squad).
  ...
  - squad composition/formation can only be changed between runs
...
8. Advancement phase.
  ...
  - equip/unequip dice between runs
  - promote units manually between runs (primary unit persists, secondary units are consumed)
9. Repeat.

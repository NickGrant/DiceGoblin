...
**Milestone 5 - Complete Farm: Complete; manual UAT passed.**

All seven implementation/technical-closure packages passed architectural review, with integrated technical closure at `9825a62f567fca39445674fc7fc71d3f2038c253`. Focused manual UAT passed on 2026-09-19 with no issues across the complete Combat -> Loot -> Rest -> Mudking Boss -> Exit -> Camp path, including durable Teeth, XP/levels, Mountains unlock state, terminal run cleanup, and post-run Warband editing.

**Milestone 6 - Prove Region Generalization: Complete; manual UAT passed.**
...
5. Boss-node authoritative resolution + finalized Farm boss rewards/XP + Mountains unlock. **Approved at `a466d3a226ff2ad1b7edee33fda2ca8333466def` after focused frontend current-run contract correction.**
6. Exit-node resolution + successful run termination + authoritative Camp/RunScene/unlock reconciliation. **Approved at `d46f09a514c7401c3e39bf14c075b0309f62566b` after focused MySQL verification.**
7. Complete-Farm integrated verification/closure. **Approved at `9825a62f567fca39445674fc7fc71d3f2038c253`.**
8. Focused manual UAT before Milestone 6 promotion. **Passed on 2026-09-19 with no issues.**
...
2. Region-neutral Boss reward + terminal Exit resolution contracts. **Approved at `a667ee703da5f868fd65218199ad271553110bc6`; MySQL/Docker proof completed with no defects.**
3. Mountains authored run graph/events/rewards + terminal lifecycle. **Approved at `f06e150e68ef39c7eeab1299a61d00a6dd2f9bea`.**
4. Unlock-aware multi-region run start + Camp region selection/resume. **Approved at `739276df0207c1ce0e845bd938546645f5f387b2`; MySQL/Docker closure passed.**
5. Mountains integrated verification/closure. **Approved at `5c8548d8b70f10d16470a564c53d13d48d10b3e2`.**
6. Focused manual UAT before Milestone 7 promotion. **Passed on 2026-09-25 after focused playback corrections through `bb49a28b41381b8ececb7fb3cf74b3a346d2116a`.**
...
## Milestone 7 Package Sequence
1. Authored item + inventory foundation. **Approved at `3b15fc3024ef12499624e71df8740f3d5912fadb`; MySQL/Docker closure passed.**
...
Milestone 5 established rewards/XP/unlocks and completed the remaining Farm nodes. Package 1 established authored event/reward/unlock contracts plus minimal `user_unlocks`/`resolved_events` persistence and real bootstrap unlock reads. Package 2 established the exact immutable reward result and grant application boundary. Unit XP is progress within the current level; level `L` costs `100 × L` XP to advance, excess carries across levels, tier/type does not change the curve, and level-up does not heal current run HP. Package 3 made Farm Loot and Rest playable through the shared bodyless node-resolution endpoint: Loot is an authored deterministic 8-Teeth event, Rest is a direct full-recovery effect, and semantic response mismatch retains the original retry identity. Package 4 established Mudking content and deterministic boss combat while preserving the unsupported live Boss boundary. Package 5 resolves the Boss authoritatively and applies exactly 16 XP per participating unit plus the permanent Mountains unlock through the finalized reward pipeline; broader prototype boss drops are intentionally not revived. Package 5 was approved at `a466d3a226ff2ad1b7edee33fda2ca8333466def` after the strict current-run contract was generalized to battle-bearing Combat-or-Boss nodes. Package 6 terminates the run through Exit with authoritative same-runtime Camp/progression reconciliation and was approved at `d46f09a514c7401c3e39bf14c075b0309f62566b` after focused MySQL verification. Package 7 completed integrated Complete-Farm technical closure and was approved at `9825a62f567fca39445674fc7fc71d3f2038c253`. Focused manual UAT passed on 2026-09-19 with no issues. Milestone 5 is closed. Mountains gameplay and second-region generalization are now Milestone 6. Package 1 established canonical Mountains/kobold combat and was approved at `4adff479b4c10af40057f1f93088c0930e5894d8`. Package 2 generalized Boss rewards and terminal Exit semantics and was approved at `a667ee703da5f868fd65218199ad271553110bc6` after MySQL/Docker verification (Boss 12 tests / 111 assertions / 0 skipped; Exit/Loot/Rest 17 / 143 / 0; full Docker backend 590 / 2,475 / 148 skipped). Package 3 established the canonical seven-node Mountains run, authored 8-Teeth Loot and XP-only Boss rewards, proved the shared MySQL lifecycle, removed the Mountains-specific PHP graph mirror, and made RunScene region-neutral. It was approved at `f06e150e68ef39c7eeab1299a61d00a6dd2f9bea`. Package 4 made region availability authoritative and unlock-aware through one shared server policy, exposed available authored regions through Camp without adding a second start path, and was approved at `739276df0207c1ce0e845bd938546645f5f387b2` after MySQL proof (Bootstrap 6/51/0 skipped; Run Start 28/255/0; full backend 599/2,527/150 skipped). Package 5 closed the technical milestone at `5c8548d8b70f10d16470a564c53d13d48d10b3e2` by proving the composed Farm-to-Mountains progression through production composition, retaining normal public Mountains start, shared node/battle/reward/terminal behavior, and auditing the registered vNext execution surface for residual Farm-only assumptions. Package 6 completed focused manual UAT on 2026-09-25. The full Farm-to-Mountains player path passed; focused status-playback corrections through `bb49a28b41381b8ececb7fb3cf74b3a346d2116a` closed the final defect. Milestone 6 is complete. Milestone 7 now owns economy and inventory.

Milestone 7 Package 1 established the canonical authored item/inventory foundation and was approved at `3b15fc3024ef12499624e71df8740f3d5912fadb` after focused MySQL proof (inventory 6/20; baseline 8/66; full Docker backend 613/2,554/150 skipped). Package 2 now establishes authored Shop offers and the authoritative read contract before any spending mutation.

Milestone 6 manual UAT otherwise passed the complete Farm-to-Mountains player path. The approved Mountains graph remains linear for Milestone 6; branching/route choice is explicitly deferred to Milestone 10. The stale four-Basic-Goblins starter reference is not a vNext requirement. Die-size acquisition eligibility is deferred to Milestone 8; Milestone 7 must simply avoid >d8 acquisition entries in the interim.

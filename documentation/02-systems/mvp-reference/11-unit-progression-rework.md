...
Depends On:
  ...
  - documentation/02-systems/mvp-reference/09-ability-loadout-combat-rework-plan.md
  - documentation/02-systems/mvp-reference/10-promotion-structure-evaluation.md
Category: 02-systems
Tags:
  - systems
  - mvp-reference

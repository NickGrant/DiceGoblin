...
-- BEGIN MIGRATION: 83_remove_pattern_v2_placeholder_mountain_dialogue.sql
SET @v2_mountain_start = JSON_OBJECT(
  'schema_version', 'pattern-v2',
  'slug', 'v2_mountain_start_cluster',
  'version', 1,
...
-- END MIGRATION: 83_remove_pattern_v2_placeholder_mountain_dialogue.sql

-- BEGIN MIGRATION: 84_seed_pattern_v2_swamp_tiles.sql
...
-- BEGIN MIGRATION: 86_seed_chaos_encounter_templates.sql
INSERT INTO `enemy_templates` (
  `slug`,
  `name`,
  `tier`,
...
-- END MIGRATION: 86_seed_chaos_encounter_templates.sql

-- BEGIN MIGRATION: 87_user_codex_entries.sql
...
-- END MIGRATION: 87_user_codex_entries.sql

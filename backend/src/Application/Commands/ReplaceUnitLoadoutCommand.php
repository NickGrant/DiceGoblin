...
final class ReplaceUnitLoadoutCommand
{
  ...
  {
    $configuration = UnitLoadoutConfiguration::fromRequest($request);
    try {
      ...
      $this->units->replaceLoadout($unitId, $configuration->abilities);

    ...
    private static function buildDefinitions(): array
    {
        return [
            ...
            AbilityDefinition::active(
                ...
                order: 17,
                defaultTarget: AbilityTarget::EnemyBackPrefer,
                displayName: 'Bomb Toss',
                shortDesc: 'Lobs a volatile charge that detonates after a short fuse.',
                iconKey: 'icon_ability_bomb_toss',
                tags: ['ranged', 'damage', 'debuff', 'explosive'],
                defaultParams: [
                    'power_ratio' => 0.75,
                    'status_id' => 'fuse_lit',
                    'bomb_damage_ratio' => 0.9,
                    'duration_rounds' => 1,
                ],
            ),
            AbilityDefinition::active(
                abilityId: 'bog_splash',
                speed: 8,
                diceCost: 1,
                order: 17,
                defaultTarget: AbilityTarget::EnemyFrontPrefer,
                displayName: 'Bog Splash',
                shortDesc: 'A filthy swamp strike that leaves armor and footing compromised.',
                iconKey: 'icon_ability_bog_splash',
                tags: ['melee', 'damage', 'debuff', 'swamp'],
                defaultParams: [
                    'power_ratio' => 0.9,
                    'status_id' => 'cracked_armor',
                    'defense_reduction_flat' => 2,
            ...
            AbilityDefinition::active(
                abilityId: 'swamp_holler',
                speed: 8,
                diceCost: 1,
                order: 8,
                defaultTarget: AbilityTarget::AllyHighestAttack,
                displayName: 'Swamp Holler',
                shortDesc: 'A ragged bayou shout that riles up an ally.',
                iconKey: 'icon_ability_swamp_holler',
                tags: ['support', 'buff', 'swamp'],
                defaultParams: [
                    'status_id' => 'warcry',
                    'attack_pct' => 0.14,
                    'duration_rounds' => 2,
            ...
            AbilityDefinition::active(
                abilityId: 'reed_spear',
                speed: 8,
                diceCost: 1,
                order: 18,
                defaultTarget: AbilityTarget::EnemyFrontPrefer,
                displayName: 'Reed Spear',
                shortDesc: 'A crude spear thrust that slips past some armor.',
                iconKey: 'icon_ability_reed_spear',
                tags: ['melee', 'damage', 'piercing', 'swamp'],
                defaultParams: [
                    'power_ratio' => 1.35,
                    'ignore_defense_flat' => 2,
                ],

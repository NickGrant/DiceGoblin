...
/**
 * File: C:\xampp\htdocs\dice-goblin\backend\src\Combat\Abilities\Handlers\Active\AimedShot.php
...
final class AimedShot implements ActiveAbilityHandlerInterface
{
    public function id(): string { return 'aimed_shot'; }
    ...
    public function resolve(CombatContext $ctx, UnitRef $actor, array $cfg): void
    {
        ...
        $ctx->dealDamage($actor, $target, $ratio, ['ability_id' => $this->id(), 'tag' => 'ranged_burst']);
    }
}

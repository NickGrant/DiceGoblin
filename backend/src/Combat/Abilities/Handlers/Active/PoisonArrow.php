...
/**
 * File: C:\xampp\htdocs\dice-goblin\backend\src\Combat\Abilities\Handlers\Active\PoisonArrow.php
...
final class PoisonArrow implements ActiveAbilityHandlerInterface
{
    public function id(): string { return 'poison_arrow'; }
    ...
    public function resolve(CombatContext $ctx, UnitRef $actor, array $cfg): void
    {
        ...
        $ctx->dealDamage(
            ...
            ['ability_id' => $this->id(), 'tag' => 'ranged_poison']
        );

...
#### Completion
Run applicable database/backend/context gates from `agent/QUALITY_GATES.md`. If all criteria pass, update execution state per `agent/BACKLOG_OPERATIONS.md`; do not begin the next package in the same change unless explicitly requested.

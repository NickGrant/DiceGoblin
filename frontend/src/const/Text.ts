...
export const TEXT_BUTTON: Phaser.Types.GameObjects.Text.TextStyle = {
  fontFamily: '"Saira Stencil One", system-ui, -apple-system, "Segoe UI", Roboto, Arial',
  fontSize: "34px",
  color: UI_COLORS.ink,
  align: "center",

  // Phaser supports stroke + shadow; we use them lightly so the label stays crisp
  stroke: "rgba(233,216,184,0.55)", // parchment-ish halo for busy textures
  strokeThickness: 2,

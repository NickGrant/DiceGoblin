...
const UNIT_IMAGE_SLUG_MAP: Record<string, string> = {
  ...
  kobold: 'kobold_skirmisher',
  sentry: 'kobold_skirmisher',
  kobold_sentry: 'kobold_skirmisher',
  'kobold sentry': 'kobold_skirmisher',
  scout: 'kobold_skirmisher',
  kobold_scout: 'kobold_skirmisher',
  'kobold scout': 'kobold_skirmisher',

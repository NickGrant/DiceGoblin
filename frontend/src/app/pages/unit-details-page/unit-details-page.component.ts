    ...
    return [
      {
        ...
        tooltip: 'Tier reflects this unit type branch and rough power band.',
      },
      {
        icon: this.faArrowUp,
        label: 'Level',
        ...
        tooltip: 'Level increases as the unit earns XP, unlocking promotions and stronger totals.',
      },
      {
        ...
        tooltip: 'HP is how much damage this unit can take before being defeated.',
      },
      {
        ...
        tooltip: 'Attack increases the damage this unit deals with attack actions.',
      },
      {
        icon: this.faTrophy,
        label: 'Precision',
        ...
        tooltip: 'Precision helps actions connect and improves offensive reliability.',
      },
      {
        ...
        tooltip: 'Defense reduces incoming damage from enemy attacks.',
      },
      {
        icon: this.faShieldHalved,
        label: 'Resolve',
        ...
        tooltip: 'Resolve helps resist harmful status effects and pressure.',
      },
    ];
  });
